...
from io import BytesIO as BytesBuffer
...
class Middleware(object):
    """
    SigSci Middleware Modules for Python 3
    """
    ...
    def _is_anomalous(self, response) -> bool:
...
def _valid_content_type(ctype: str) -> bool:
    """
...
def _get_server_name(environ) -> str:
    """
